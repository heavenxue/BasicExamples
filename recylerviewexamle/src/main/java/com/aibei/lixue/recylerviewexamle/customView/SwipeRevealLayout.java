...
public class SwipeRevealLayout extends FrameLayout {
    ...
    public interface SwipeListener {
        ...
        void onUpdate(SwipeRevealLayout layout, int leftOffset, int topOffset);

        void onHandRelease(SwipeRevealLayout layout, float xvel, float yvel);
    }
    ...
    private ViewDragHelper.Callback mDragHelperCallback = new ViewDragHelper.Callback() {
        ...
        public void onViewReleased(View releasedChild, float xvel, float yvel) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                l.onHandRelease(SwipeRevealLayout.this, xvel, yvel);
            }
    ...
    protected void dispatchSwipeEvent(int surfaceLeft, int surfaceTop, boolean open) {
        ...
        if (!mSwipeListeners.isEmpty()) {
            ...
            for (SwipeListener l : mSwipeListeners) {
                ...
                l.onUpdate(SwipeRevealLayout.this, surfaceLeft - getPaddingLeft(), surfaceTop - getPaddingTop());
            }

            if (status == Status.Close) {
                for (SwipeListener l : mSwipeListeners) {
                    l.onClose(SwipeRevealLayout.this);
                }
                mEventCounter = 0;
            }
            ...
            if (status == Status.Open) {
                ...
                for (SwipeListener l : mSwipeListeners) {
                    l.onOpen(SwipeRevealLayout.this);
                }
                mEventCounter = 0;
            }
        }
    ...
    public interface OnLayout {
        void onLayout(SwipeRevealLayout v);
    }
    ...
    private void performAdapterViewItemClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            int p = view.getPositionForView(SwipeRevealLayout.this);
    ...
    private boolean performAdapterViewItemLongClick() {
        ...
        if (t instanceof AdapterView) {
            ...
            try {
                ...
                handled = (boolean) m.invoke(view, SwipeRevealLayout.this, p, vId);

            } catch (Exception e) {
                e.printStackTrace();

                if (view.getOnItemLongClickListener() != null) {
                    handled = view.getOnItemLongClickListener().onItemLongClick(view, SwipeRevealLayout.this, p, vId);
                }
                if (handled) {
    ...
    class SwipeDetector extends GestureDetector.SimpleOnGestureListener {
        ...
        public boolean onDoubleTap(MotionEvent e) {
            if (mDoubleClickListener != null) {
                ...
                mDoubleClickListener.onDoubleClick(SwipeRevealLayout.this, target == surface);
            }
            return true;
        }
    }
    ...
    public interface DoubleClickListener {
        void onDoubleClick(SwipeRevealLayout layout, boolean surface);
    }
