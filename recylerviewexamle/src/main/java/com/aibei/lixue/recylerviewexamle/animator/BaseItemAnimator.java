...
import com.aibei.lixue.recylerviewexamle.animator.holder.AnimateViewHolder;
import com.aibei.lixue.recylerviewexamle.utils.ViewHelper;

import java.util.ArrayList;
import java.util.List;

/**
 * 作者：lixue on 2017/2/21 15:17
 */
...
public abstract class BaseItemAnimator extends SimpleItemAnimator {
    ...
    private ArrayList<ViewHolder> mPendingRemovals = new ArrayList<>();//移除
    private ArrayList<ViewHolder> mPendingAdditions = new ArrayList<>();//增加
    private ArrayList<MoveInfo> mPendingMoves = new ArrayList<>();//移动
    private ArrayList<ChangeInfo> mPendingChanges = new ArrayList<>();//改变
    ...
    protected ArrayList<ViewHolder> mAddAnimations = new ArrayList<>();//增加动画
    private ArrayList<ViewHolder> mMoveAnimations = new ArrayList<>();//移动动画
    protected ArrayList<ViewHolder> mRemoveAnimations = new ArrayList<>();//移除动画
    private ArrayList<ViewHolder> mChangeAnimations = new ArrayList<>();//改变动画
