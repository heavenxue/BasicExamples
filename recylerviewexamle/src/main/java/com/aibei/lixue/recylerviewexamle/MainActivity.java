...
import com.aibei.lixue.recylerviewexamle.customView.Attributes;
...
//        recyclerView.setLayoutManager(new StaggeredGridLayoutManager(2, OrientationHelper.VERTICAL));//这里用线性宫格显示 类似于瀑布流
        ...
        switch (adapterType){
            ...
            case 4:
                ...
                mAdapter = new SlideInLeftAdapter(this, stringList);
                ((SlideInLeftAdapter) mAdapter).setMode(Attributes.Mode.Single);
